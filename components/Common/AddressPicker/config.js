...
export const areasData = {
  ...
  葫芦岛市: ['连山区', '龙港区', '南票区', '绥中县', '建昌县', '兴城市', '杨家杖子经济开发区'],
  长春市: [
    '南关区',
    '宽城区',
    '朝阳区',
  ...
  无锡市: ['崇安区', '南长区', '北塘区', '锡山区', '惠山区', '滨湖区', '江阴市', '宜兴市', '新区'],
  徐州市: [
    '鼓楼区',
    '云龙区',
    '贾汪区',
  ...
  扬州市: ['广陵区', '邗江区', '江都区', '宝应县', '仪征市', '高邮市', '江都市'],
  镇江市: ['京口区', '润州区', '丹徒区', '丹阳市', '扬中市', '句容市', '镇江新区'],
  ...
  淮南市: ['大通区', '田家庵区', '谢家集区', '八公山区', '潘集区', '凤台县', '淮南高新技术开发区'],
  ...
  威海市: ['环翠区', '经济技术开发区', '文登市', '荣成市', '乳山市', '高区'],
  日照市: ['东港区', '岚山区', '新市区', '五莲县', '莒县'],
  莱芜市: ['莱城区', '钢城区'],
  临沂市: [
    '兰山区',
    '罗庄区',
  ...
  梧州市: ['万秀区', '蝶山区', '长洲区', '苍梧县', '藤县', '蒙山县', '岑溪市', '龙圩区'],
